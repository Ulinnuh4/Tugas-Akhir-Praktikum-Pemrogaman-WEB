    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="dashboard.php?halaman=produk" class="sidebar-link">
                        <i class="lni lni-cart"></i>
                        <span>Produk</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="dashboard.php?halaman=pembelian" class="sidebar-link">
                        <i class="lni lni-wallet"></i>
                        <span>Pembelian</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="dashboard.php?halaman=pelanggan" class="sidebar-link">
        ...
        <form action="" method="POST" class="login-email">
            <div class="deskripsi d-flex align-item-center p-3">
            <?php echo "<h1>SELAMAT DATANG👋, <span>" .$_SESSION['username'] ."!". "</span></h1>";
            ?> 
            <hr>
            </div>
        </form>
