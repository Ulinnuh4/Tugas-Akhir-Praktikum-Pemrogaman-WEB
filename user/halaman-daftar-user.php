...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../kumpulan_css/daftar-user.css">
  ...
  <div class="kontainer-1">
        ...
        <form action="halaman-daftar-user.php" method="post">
            <div class="mb-3">
            ...
            <div class="tombol d-flex">
                ...
                <a href="./halaman-login-user.php" class="login">Login</a>
            </div>
        </form>
    </div>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $email_check_query = "SELECT * FROM pelanggan WHERE email_pelanggan= '$email' LIMIT 1";
            ...
            if ($user) { // jika email sudah ada
                ...
                $sql = "INSERT INTO pelanggan VALUES ('','$email', '$pw','$username', '$telepon')";
                mysqli_query($connect, $sql);
                echo "<script>alert('Anda Berhasil Mendaftar')</script>";
                echo "<meta http-equiv='refresh' content='1;url=halaman-login-user.php'>";
            }
        }
    ?>
